package com.padc.batch9.assignment13.util;
...
public class ScreenUtils {
     ...
     * Show soft keyboard in some situation.
     */
    public static void showSoftKeyboardWithForce(Context context) {
        InputMethodManager imm = (InputMethodManager) context.getSystemService(Service.INPUT_METHOD_SERVICE);
        if (imm != null) {
    ...
    public static void hideKeyboardWithForce(Context ctx) {
